    ...
    return (
        <ImageBackground style={{ flex: 1, backgroundColor: 'white' }} source={require('../../assets/icons/Pattern.png')}>
            <View style={{ flex: 2, alignItems: 'center' }}>
                ...
                <Text style={{ fontFamily: 'BentonSans Bold', paddingTop: hp(2), fontSize: 23 }}>Your Profile Is Ready To Use</Text>
                <LinearGradient colors={["#53E88B", "#15BE77"]}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 0 }}
                    style={{ borderRadius: 20 , marginTop: hp(25)}}
                >
                    <TouchableOpacity onPress={() => navigate("Otp")}>
                        <Text style={{ borderWidth: 1, borderWidth: 0, paddingHorizontal: wp(12), paddingVertical: hp(2.6), fontFamily: 'BentonSans Bold', color: 'white', fontSize: 16 }}>Try Order</Text>
                    </TouchableOpacity>
                </LinearGradient>
                {/* <Button mode="contained"
                    ...
                    <Text style={{ fontFamily: 'BentonSans Bold', color: 'white', fontSize: 16 }}>Try Order</Text>
                </Button> */}
            </View>
        </ImageBackground>
    )
