        ...
        <ImageBackground style={{ flex: 1, backgroundColor: '#FEFEFF' }} source={require('../../../assets/icons/Pattern.png')}>
            <ScrollView>
                <View style={{ alignItems: 'center' }}>
                    <ImageBackground style={{ height: 170, marginTop: hp(20), width: 180, paddingTop: hp(2), alignItems: 'center' }} source={require('../../../assets/icons/Elipse.png')}>
                        <Image style={{ height: 150, width: 150 }} source={require('../../../assets/icons/Image1.png')} />
                    </ImageBackground>
                    <Text style={{ fontFamily: 'BentonSans Bold', marginTop: hp(6), fontSize: 25 }}>Thank You!</Text>
                    <Text style={{ fontFamily: 'BentonSans Bold', marginTop: hp(0.5), fontSize: 25 }}>Order Completed</Text>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between',paddingTop:hp(2),paddingHorizontal: wp(7)}}>
                    ...
                    <TouchableOpacity onPress={()=>navigate('Foodrate')} style={{ alignItems: 'center',height:hp(8),width:wp(20),justifyContent:'center',borderRadius:15,elevation:7,marginBottom:hp(2),backgroundColor:'white' }}>
