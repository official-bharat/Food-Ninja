        ...
        <ImageBackground style={{ flex: 1, backgroundColor: '#FEFEFF' }} source={require('../../../assets/icons/Pattern.png')}>
            <ScrollView>
                <View style={{ alignItems: 'center' }}>
                    <Image style={{ height: 180, width: 185,marginTop:hp(18) }} source={require('../../../assets/icons/Rate.png')} />
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: hp(2), paddingHorizontal: wp(7) }}>
                    ...
                    <TouchableOpacity onPress={()=>navigate('Restorate')} style={{ alignItems: 'center', height: hp(8), width: wp(20), justifyContent: 'center', borderRadius: 15, elevation: 7, marginBottom: hp(2), backgroundColor: 'white' }}>
